            ...
            <div className="container mx-auto px-8 md:px-16 lg:px-24">
                ...
                <div className="flex flex-col md:flex-row items-center md:space-x-12">
                    <div className="flex-1">
                        ...
                        <p>I am eager to disscussing about projects & make an aliance.</p>
                    ...
                    <div className="flex-1 w-full">
                        <form className="space-y-4">
                            ...
                            <button className="bg-gradient-to-r from-green-400 to-blue-500 text-white hidden md:inline transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full cursor-pointer">Submit</button>
